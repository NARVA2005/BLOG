...
import { crearPublicacion,editarPublicacion, desactivarPublicacion, TraerTodasEntradas, TraerTodasID} from '../controllers/entradas.js';
...
router.get('/TraerPorID/:idEntradas', TraerTodasID);
